...
const Home = ({ usersD, userId, isUserlog }) => {
    ...
    useEffect(() => {
        setWelcomPage(<div style={{ height: "85vh" }}>
            <div className="container ui segment" style={{ height: "85vh" }}>
                <br></br>
                <h1 style={{ textAlign: 'center' }}>
                    Sing in and be the story everyone is talking about
            </h1>
                <img style={{ width: '340px' }} className="ui small left floated image" src="https://image.freepik.com/free-vector/learning-concept-illustration_114360-3454.jpg" alt='img' />
                ...
                <img style={{ width: '340px' }} className="ui small right floated image" src="https://image.freepik.com/free-vector/programming-concept-illustration_114360-1351.jpg" alt='img' />
