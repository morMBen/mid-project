                    ...
                    >
                        <div className="item">
                            ...
                            <div className="content" >
                                ...
                                <div className="description" style={{ fontSize: '16px', lineHeight: '1.5rem' }}>{ReactHtmlParser(summary)}<h5>{Math.round(numberOfWords / 200)} Minuts reading</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {deletedItem &&
                    <div style={{ display: "flex", alignItems: "center", fontSize: "2rem" }}>
                        ...
                        >
                            <Link
                                style={{ color: "black" }}
                                to={`/my-account/${uName.split(' ').join('')}/${uTitle.split(' ').join('')}/edit`}>
